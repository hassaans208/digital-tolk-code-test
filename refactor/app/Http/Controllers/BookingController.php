...
class BookingController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        : ($user_type == env('ADMIN_ROLE_ID') || $user_type == env('SUPERADMIN_ROLE_ID') 
    ...
    public function distanceFeed(Request $request)
    {
        ...
        $flagged = filter_var($data['flagged'], FILTER_VALIDATE_BOOLEAN) ? 'yes' : 'no';
        $admincomment = isset($data['admincomment']) ? $data['admincomment'] : '';
        $manually_handled = filter_var($data['manually_handled'], FILTER_VALIDATE_BOOLEAN) ? 'yes' : 'no';
        $by_admin = filter_var($data['by_admin'], FILTER_VALIDATE_BOOLEAN) ? 'yes' : 'no';
